...
function ChatHeader({ mode, handleResetDemo }: { mode: string, handleResetDemo: () => void }) {
  return (
...
function ChatInputArea({
  input, setInput, isLoading, mode, inputRef, handleSend, handleSuggestedClick, suggestedQuestions, hasMessages
}: {
  ...
  return (
    <div className="flex h-[calc(100vh-10rem)] max-w-7xl mx-auto gap-6">
      ...
      <div className="flex-1 flex flex-col bg-card/25 border border-border/40 rounded-2xl overflow-hidden shadow-sm relative">
        <ChatHeader mode={mode} handleResetDemo={handleResetDemo} />
