    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between border-b border-border/40 pb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl font-bold tracking-tight text-foreground">Smart Suggestions</h2>
            <p className="text-sm text-muted-foreground mt-0.5">Review recommendations generated by J.A.R.V.I.S. to organize workspaces & reflect beliefs.</p>
          </div>
        </div>
      </div>
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center min-h-[40vh] space-y-3">
          ...
          <span className="text-xs text-muted-foreground tracking-widest uppercase">Analyzing cognitive optimizations...</span>
        </div>
      ) : (
        <div className="space-y-6">
          {suggestions.length === 0 ? (
            <div className="border border-border/40 bg-card/25 rounded-2xl p-10 text-center text-muted-foreground flex flex-col items-center justify-center space-y-3 min-h-[250px] shadow-sm">
              ...
              <p className="text-sm font-semibold">No pending optimization suggestions.</p>
              <p className="text-xs text-muted-foreground/80 max-w-sm leading-normal">
                Subsystems are fully optimized. Ingest more documents to trigger suggestion heuristics.
              </p>
            </div>
          ) : (
